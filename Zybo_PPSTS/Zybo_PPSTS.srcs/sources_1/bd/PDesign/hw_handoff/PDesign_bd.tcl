...
################################################################
# This is a generated script based on design: PDesign
#
...
proc create_root_design { parentCell } {
  ...
  set PPSOut_0 [ create_bd_port -dir O PPSOut_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins Fix/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net GPS_EN_0_Fix [get_bd_pins Fix/gpio_io_i] [get_bd_pins GPS_EN_0/Fix]
  connect_bd_net -net GPS_EN_0_PPSOut [get_bd_ports PPSOut_0] [get_bd_pins GPS_EN_0/PPSOut]
  connect_bd_net -net PPSIn_0_1 [get_bd_ports PPSIn_0] [get_bd_pins GPS_EN_0/PPSIn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Fix/s_axi_aclk] [get_bd_pins GPS_EN_0/CLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Fix/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Fix/S_AXI/Reg] SEG_Fix_Reg
