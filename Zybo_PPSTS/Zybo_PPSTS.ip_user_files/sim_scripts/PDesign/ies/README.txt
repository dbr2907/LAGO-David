...
#
# Generated by export_simulation on Wed Feb 06 12:11:28 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './PDesign.sh' script.

./PDesign.sh -reset_run
...
./PDesign.sh -noclean_files

For more information on the script, please type './PDesign.sh -help'.
