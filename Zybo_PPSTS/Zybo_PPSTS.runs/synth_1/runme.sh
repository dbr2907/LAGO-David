...
HD_PWD='C:/Users/David/Zybo_PPSTS/Zybo_PPSTS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PDesign_wrapper.tcl
