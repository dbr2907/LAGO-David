...
HD_PWD='C:/Users/David/Zybo_PPSTS/Zybo_PPSTS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PDesign_wrapper.tcl -notrace
