...
#define comblock_reg_block_addr	XPAR_COMBLOCK_0_AXIL_REGS_BASEADDR
...
#define comblock_TDPR_highaddr XPAR_COMBLOCK_0_AXIF_DRAM_HIGHADDR

#define comblock_FIFO_RD XPAR_COMBLOCK_0_AXIF_FIFO_BASEADDR
#define comblock_FIFO_STATUS comblock_FIFO_RD+4


//comblock_FIFO_STATUS(0) empty
//comblock_FIFO_STATUS(1) aempty
//comblock_FIFO_STATUS(2) underflow
//comblock_FIFO_STATUS(3) full
//comblock_FIFO_STATUS(4) afull
//comblock_FIFO_STATUS(5) overflow
